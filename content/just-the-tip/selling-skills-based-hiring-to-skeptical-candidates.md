...
1. **Some companies DO use "skills-based" as an excuse to lowball**: "We'll hire you without a degree... but we'll pay you 20% less than someone with one."

2. **"Degree optional" has been used as a euphemism for "entry-level pay for experienced work"**: Candidates have seen postings that say "no degree required" but expect 5 years of experience—and offer compensation appropriate for someone fresh out of college.

3. **There's no transparency**: Many job postings say "skills-based" but don't explain what that actually means for compensation, career progression, or how candidates will be evaluated.
