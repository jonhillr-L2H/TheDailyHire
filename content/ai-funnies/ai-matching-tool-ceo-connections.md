---
title: Our AI Candidate Matching Tool Only Recommended People From The CEO's LinkedIn Connections (And His Fantasy Football League)
excerpt: >-
  We bought an AI tool that promised to match candidates to roles using advanced
  algorithms. Instead, it only recommended people connected to our CEO on
...
> Current role: Junior Account Executive
> Experience: 2 years
> Match score: 94%
>
...
1. I created a fake LinkedIn profile (using a stock photo and fake name)
2. I made the profile a "Senior Engineering Manager" with 15 years of experience and perfect qualifications for our open roles
3. I did NOT connect the profile to our CEO
...
1. **Ask how the AI prioritizes candidates** (ours prioritized LinkedIn connections)
2. **Test it with roles you've already filled** (we didn't)
3. **Check if recommended candidates are actually qualified** (we eventually did)
4. **Don't assume "AI" means "better"** (it often doesn't)
